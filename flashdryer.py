...
Cassava_demand = sel_col.slider('approximately how many tons of cassava roots would be available for processing at your site', min_value=16.3, max_value=11.42, value=48.9, step=16.3)
R= Cassava_demand
def load_data():
